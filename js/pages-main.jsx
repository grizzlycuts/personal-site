    ...
    <section className={"splash" + toneClass}>
      ...
      <div className="wrap-wide splash-body">
        ...
        <div className="row gap-m" style={{ marginTop: 8, flexWrap: "wrap" }}>
          ...
          <button className="btn btn-ghost" onClick={() => go("album")}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" style={{ verticalAlign: "middle", marginRight: 5 }}>
              <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/>
              <circle cx="12" cy="13" r="4"/>
            </svg>
            Gallery
          </button>
          <button className="btn btn-ghost" onClick={() => go("projects")}>Selected work</button>
        </div>
        <SocialIcons />
      </div>
