...
window.SITE = {
  ...
  /* ---- NOW ---- */
  now: [
    { label: "Grading", body: "Finishing a six-part limited series — HDR master plus SDR trim. Reel four of six." },
    { label: "Flying", body: "Training a new 3-way camera slot for the spring boogie season. Targeting golden-hour exits." },
    { label: "Building", body: "A small LUT pack distilled from five years of show looks. Quiet, filmic, restrained." },
    { label: "Reading", body: "Notes on color science and a stack of weather almanacs. Same skill, two domains." },
  ],
